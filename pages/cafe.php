...
<table class="table">
    ...
    <tr>
        ...
        <td><a href="upd_cafe.php?id=<?= $product["id"]?>">Update</a></td>
        <td><a onclick="return confirm('Are you sure?')" style="color: red" href="/src/PHP/del_cafe.php?id_cafe=<?= $product["id"] ?>">Delete</a></td>
    </tr>
    <?php
    }
    ?>
